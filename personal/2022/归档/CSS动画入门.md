...
|---|---|
|[[CSS动画入门/无标题/animation(动画)]]|用于设置动画属性, 这是一个简写的属性, 包含6个属性|
|[[CSS动画入门/无标题/transition(过渡)]]|用于设置元素的过渡样式, 和animation有着类似的效果, 但是细节上有很大不同|
|[[CSS动画入门/无标题/transform(变形)]]|用于设置元素进行旋转, 缩放, 移动, 和设置样式的动画并没有什么关系, 就相当于color一样,用来设置元素的外表|
|[[CSS动画入门/无标题/translate(移动)]]|translate只是transform的一个属性值|
...
|---|---|
|[[CSS动画入门/无标题 1034-4d61/property]]|设置过渡效果CSS属性名称|
|[[CSS动画入门/无标题 1034-4d61/duration]]|规定完成过渡效果需要多少时间|
|[[CSS动画入门/无标题 1034-4d61/timing-function]]|规定速度效果的速度曲线|
|[[CSS动画入门/无标题 1034-4d61/delay]]|定义过渡效果何时开始|
...
|![](https://www.notion.so/icons/font_gray.svg)值|![](https://www.notion.so/icons/description_gray.svg)描述|
|---|---|
|[[CSS动画入门/无标题 76b8-008d/name]]|用来调用@keyframes定义好的动画|
...
|[[CSS动画入门/无标题 76b8-008d/Iteration-count]]|定义动画的播放次数|
|[[CSS动画入门/无标题 76b8-008d/direction]]|设置动画播放方向|
|[[CSS动画入门/无标题 76b8-008d/play-state]]|控制元素动画的播放状态, pause running|
|[[CSS动画入门/无标题 76b8-008d/fill-mode]]|控制动画结束后元素的样式|
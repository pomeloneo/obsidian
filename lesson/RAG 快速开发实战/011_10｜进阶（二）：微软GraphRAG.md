...
原文链接：https://time.geekbang.org/column/article/809146

---

[![](https://static001.geekbang.org/resource/image/20/e6/20a23e55d38fe4bea1cb2e0d28f851e6.jpg)](https://static001.geekbang.org/resource/image/20/e6/20a23e55d38fe4bea1cb2e0d28f851e6.jpg)
...
[![](https://static001.geekbang.org/resource/image/81/ff/81yy9204618f747fa0f487a86c71d9ff.jpg?wh=1920x1849)](https://static001.geekbang.org/resource/image/81/ff/81yy9204618f747fa0f487a86c71d9ff.jpg?wh=1920x1849)
...
[![](https://static001.geekbang.org/resource/image/yy/69/yy2eaf4292effa4bdc821efe502a9d69.png?wh=900x570)](https://static001.geekbang.org/resource/image/yy/69/yy2eaf4292effa4bdc821efe502a9d69.png?wh=900x570)
...
知识图谱构建成本：知识图谱的构建依赖于从数据中识别并提取实体及其关系，传统上依赖于人工识别和提取，现在可以借助大模型来完成，但均需要大量的成本。以处理 200 页的文本为例，假设使用 ChatGPT-4 完成构建，需要进行约 449 次调用，总成本约为 11 美元。

图谱的维护与更新：知识图谱是动态的，随着新的数据和知识不断涌现，图谱需要持续更新以保持其准确性和时效性。维护和更新图谱需要定期重新处理数据，以确保新添加的实体和关系与现有结构保持一致。

### 微软 GraphRAG 详解

[![](https://static001.geekbang.org/resource/image/26/16/267cyybdf69a3bf7bf16f7d462380c16.png?wh=1920x1077)](https://static001.geekbang.org/resource/image/26/16/267cyybdf69a3bf7bf16f7d462380c16.png?wh=1920x1077)

来源：https://neo4j.com/blog/graphrag-manifesto/

GraphRAG 通过将知识图谱中的结构化数据与输入文档中的非结构化数据相结合，利用相关实体信息来增强LLM 的上下文理解。
...
下面我们展示 GraphRAG 示例代码，更多细节查看 GraphRAG 官网。
...
GraphRAG 通过将 RAG 与知识图谱相结合，显著提升了 RAG 在处理复杂信息和多跳推理方面的能力。GraphRAG 的核心优势在于结构化地表示实体及其关系，增强了语义理解和检索效率，从而提高了答案的准确性和完整性。同时，它还提升了可解释性和可追溯性。
...
针对知识图谱构建和维护成本高的挑战，可以采用哪些方法或策略来降低成本、提高效率，从而促进 GraphRAG 的广泛应用？欢迎你在留言区分享，和我一起讨论，也欢迎你把这节课的内容分享给对 RAG 感兴趣的朋友！

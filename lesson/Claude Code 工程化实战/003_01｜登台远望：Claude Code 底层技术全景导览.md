...
原文链接：https://time.geekbang.org/column/article/942438
...
1. Claude 识别出“安全漏洞”关键词，激活 security-review Skill。

1. Skill 指示 Claude 创建一个子代理来执行测试。
...
1. 调用 code-review SubAgent

└── 隔离审查任务，避免污染主流程上下文

1. SubAgent 使用 security-check Skill

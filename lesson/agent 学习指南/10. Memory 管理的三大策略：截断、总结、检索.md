...
[![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJBmXm10gyRrYmnnVmNFsdvf4s2aDZwr17gf0ibG9dYfKcFsylp2DAndQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=4)](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJBmXm10gyRrYmnnVmNFsdvf4s2aDZwr17gf0ibG9dYfKcFsylp2DAndQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=4)

[![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJkM3HNnCcCLjnjyB9rV5mAdbgqurlwIdLVeosRbNjDKcThiaom3LpxHQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=5)](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJkM3HNnCcCLjnjyB9rV5mAdbgqurlwIdLVeosRbNjDKcThiaom3LpxHQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=5)

达到上下文限制，会自动触发总结。

**Claude Code：**

[![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJbM5MNO0GQicGa36Njhiabhmibzr4cVCXp894sL8LicOibKodJwkic2ant3Rg/640?wx_fmt=jpeg&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=6)](https://mmbiz.qpic.cn/sz_mmbiz_jpg/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJbM5MNO0GQicGa36Njhiabhmibzr4cVCXp894sL8LicOibKodJwkic2ant3Rg/640?wx_fmt=jpeg&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=6)

[![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJEcyy0aGrNkEibHmIHw1nPhrZm8a0S0kpZvnD6QO2icpRWSTMZIOtpUBg/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=7)](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJEcyy0aGrNkEibHmIHw1nPhrZm8a0S0kpZvnD6QO2icpRWSTMZIOtpUBg/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=7)

达到限制自动触发总结，或者也可以 `/compact` 手动总结（compact 是压实压紧的意思）

---

## LangChain 中的 Memory API

### 两个维度的 API

之前 memory 一共有两个维度的 api：

**存储层：ChatMessageHistory**

[![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJfeibOJ5l5AJIbRJ2TM02rCEIuOw5dgRVchzicxMSRRH7q8zotNepawOw/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=8)](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJfeibOJ5l5AJIbRJ2TM02rCEIuOw5dgRVchzicxMSRRH7q8zotNepawOw/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=8)

它是存储层，也就是 messages 存在哪，可以是内存、文件、数据库等。

**逻辑层：截断、总结、向量数据库**

[![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJpCeTpXSE9wRLqyjDCqlwP7MhicncFr6r1X47WjjJCiae2mZnjZvUel6g/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=9)](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJpCeTpXSE9wRLqyjDCqlwP7MhicncFr6r1X47WjjJCiae2mZnjZvUel6g/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=9)

每个 xxMemory 类都有一个 chatHistory 属性，关联着存储层。

### API 废弃说明

但是，这些 memory 的 api，已经全部被废弃了。移到了 `@langchain/classic` 这个包：

[![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJDEa0lBKniaTib3N8p92qsFB7lQXxFSKk1ZCW5ykOLhrjB6vNkrQWq0mg/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=10)](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJDEa0lBKniaTib3N8p92qsFB7lQXxFSKk1ZCW5ykOLhrjB6vNkrQWq0mg/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=10)
...
### 示例1：InMemoryChatMessageHistory
...
[![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJZRxqGIxMcFuqvOqHpLwibZFNzsgicgBQlaRibkHKDgTiauNmaE7iagvMPlw/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=12)](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJZRxqGIxMcFuqvOqHpLwibZFNzsgicgBQlaRibkHKDgTiauNmaE7iagvMPlw/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=12)

可以看到，第一次调用大模型，它回答了红烧肉、冬阴功汤。第二次再和它对话，它能知道之前聊过的内容，接着聊。

我们之前是用 messages 数组实现的，现在换成了 `InMemoryChatMessageHistory` 的 api。

### 示例2：FileSystemChatMessageHistory（长时记忆）

当然，保存在文件里也是可以的。你看 cursor 就是把对话过程持久化了，我们随时可以找到一个之前的聊天继续聊。

这就是 message 持久化的好处，也叫做**长时记忆（LTM long-term memory）**。

相应的，内存中那种叫**短时记忆（short-term memory）**。
...
创建 `src/history-test3.mjs`（从文件恢复历史继续对话）：
...
可以看到，我们第一轮、第二轮对话都被持久化保存到了文件里。后面可以从文件里恢复前两轮对话，继续第三轮。

基于这个完全可以实现 cursor 这种功能：

[![](https://mmbiz.qpic.cn/sz_mmbiz_gif/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJuxbPJkbohDcUiaOJqGria3DnibTsMRqsdXyJWxTMh1hicozsibLRc5brnqw/640?wx_fmt=gif&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=13)](https://mmbiz.qpic.cn/sz_mmbiz_gif/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJuxbPJkbohDcUiaOJqGria3DnibTsMRqsdXyJWxTMh1hicozsibLRc5brnqw/640?wx_fmt=gif&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=13)
...
[![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJ3oBwVxmaMVlPkRsAmicykUVImW5kibJR14QEoXib6klia5xBibGPOHaRukg/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=14)](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJ3oBwVxmaMVlPkRsAmicykUVImW5kibJR14QEoXib6klia5xBibGPOHaRukg/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=14)

[![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJ8LQzON7ekda1DRtjqFDJtO1jOrMhVpFlgv3xgOsicvbna4icYic9QFiajQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=15)](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJ8LQzON7ekda1DRtjqFDJtO1jOrMhVpFlgv3xgOsicvbna4icYic9QFiajQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=15)

可以看到，第一次是根据数量截取了 4 条最近的 message，第二次是根据 token 来截取的。

之后把截取的 messages 传给大模型调用就行了。这就是第一种策略：**截断**。

---

## 策略2：总结（Summarization）
...
[![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJkM3HNnCcCLjnjyB9rV5mAdbgqurlwIdLVeosRbNjDKcThiaom3LpxHQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=18)](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJkM3HNnCcCLjnjyB9rV5mAdbgqurlwIdLVeosRbNjDKcThiaom3LpxHQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=18)

达到上下文限制，会自动触发总结。

**Claude Code：**

[![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJbM5MNO0GQicGa36Njhiabhmibzr4cVCXp894sL8LicOibKodJwkic2ant3Rg/640?wx_fmt=jpeg&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=19)](https://mmbiz.qpic.cn/sz_mmbiz_jpg/JnZIbTicL4jUAV0SjSsJSOk1xicAEOWQBJbM5MNO0GQicGa36Njhiabhmibzr4cVCXp894sL8LicOibKodJwkic2ant3Rg/640?wx_fmt=jpeg&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=19)
...
|**检索**|结合向量数据库来做语义检索，通过 RAG 来检索之前聊的内容|

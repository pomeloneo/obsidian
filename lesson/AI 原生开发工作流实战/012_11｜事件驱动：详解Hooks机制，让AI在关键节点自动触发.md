...
原文链接：https://time.geekbang.org/column/article/931222
...
[![](https://static001.geekbang.org/resource/image/cd/55/cd37d6306e24cc182f6f2d86651de155.png?wh=1488x974)](https://static001.geekbang.org/resource/image/cd/55/cd37d6306e24cc182f6f2d86651de155.png?wh=1488x974)
...
要成为一个优秀的“AI 行为编排者”，你首先需要一张清晰的“流程图”，了解 AI 在执行一个任务时，到底会经过哪些关键的生命周期节点。这些节点，就是我们可以监听并绑定响应动作的事件源。

Claude Code 为我们开放了多个核心的 Hook 事件。让我们通过一个典型的 AI 工作流程，来看看它们各自的位置和作用。

[![](https://static001.geekbang.org/resource/image/49/43/499bd2d0af2d29529fdc37fed7b22a43.jpg?wh=2429x3128)](https://static001.geekbang.org/resource/image/49/43/499bd2d0af2d29529fdc37fed7b22a43.jpg?wh=2429x3128)
...
[![](https://static001.geekbang.org/resource/image/ef/00/efcaf0a9c4062ecdfd0708d6783ffd00.png?wh=2878x1370)](https://static001.geekbang.org/resource/image/ef/00/efcaf0a9c4062ecdfd0708d6783ffd00.png?wh=2878x1370)

### 第二步：选择 Hook 事件与 Matcher

在上图的 Select hook event 菜单中，选择 PostToolUse 事件，进入 Tool Matcher 配置页面：

[![](https://static001.geekbang.org/resource/image/ee/cc/ee8a7bd90af834f1543f8fac3fc6cdcc.png?wh=2876x604)](https://static001.geekbang.org/resource/image/ee/cc/ee8a7bd90af834f1543f8fac3fc6cdcc.png?wh=2876x604)
...
[![](https://static001.geekbang.org/resource/image/9b/8d/9b7e8340a0a2768bde854700101e9a8d.png?wh=2874x1198)](https://static001.geekbang.org/resource/image/9b/8d/9b7e8340a0a2768bde854700101e9a8d.png?wh=2874x1198)

回车确认后，完成该 matcher 添加：

[![](https://static001.geekbang.org/resource/image/ab/62/ab32cde1bc5a7a089f78cd110541ac62.png?wh=2880x612)](https://static001.geekbang.org/resource/image/ab/62/ab32cde1bc5a7a089f78cd110541ac62.png?wh=2880x612)
...
[![](https://static001.geekbang.org/resource/image/e9/8a/e908ccc40faf4d26cf659d4eef7c178a.png?wh=2854x1540)](https://static001.geekbang.org/resource/image/e9/8a/e908ccc40faf4d26cf659d4eef7c178a.png?wh=2854x1540)

输入以下命令：

[![](https://static001.geekbang.org/resource/image/e8/ae/e8e65473626dc09a927ae552a81113ae.png?wh=1676x278)](https://static001.geekbang.org/resource/image/e8/ae/e8e65473626dc09a927ae552a81113ae.png?wh=1676x278)

[![](https://static001.geekbang.org/resource/image/5a/86/5a2c3dc839858321c5f9a5e9469c2a86.png?wh=2814x1592)](https://static001.geekbang.org/resource/image/5a/86/5a2c3dc839858321c5f9a5e9469c2a86.png?wh=2814x1592)

这个命令是一个完整的 Bash 命令链，用分号 ; 分隔多个语句。让我们来逐段拆解这个命令的含义：

[![](https://static001.geekbang.org/resource/image/d8/a0/d8a5ba1c2ecba3e1441b7ed9d47186a0.jpg?wh=1890x1330)](https://static001.geekbang.org/resource/image/d8/a0/d8a5ba1c2ecba3e1441b7ed9d47186a0.jpg?wh=1890x1330)
...
[![](https://static001.geekbang.org/resource/image/9a/a2/9ab10b923cc4d919e626e3c526d17ca2.png?wh=2878x680)](https://static001.geekbang.org/resource/image/9a/a2/9ab10b923cc4d919e626e3c526d17ca2.png?wh=2878x680)
...
[![](https://static001.geekbang.org/resource/image/69/c7/69aab99e4ebb11867c46ea1e36d5fac7.png?wh=1676x1212)](https://static001.geekbang.org/resource/image/69/c7/69aab99e4ebb11867c46ea1e36d5fac7.png?wh=1676x1212)
...
[![](https://static001.geekbang.org/resource/image/07/a8/07954262ca2995e500dcb26cc0de0ba8.png?wh=2870x592)](https://static001.geekbang.org/resource/image/07/a8/07954262ca2995e500dcb26cc0de0ba8.png?wh=2870x592)
...
[![](https://static001.geekbang.org/resource/image/53/87/539145c056631f96a81b0dae7c430387.png?wh=2810x738)](https://static001.geekbang.org/resource/image/53/87/539145c056631f96a81b0dae7c430387.png?wh=2810x738)
...
[![](https://static001.geekbang.org/resource/image/a6/7e/a63ce910ed343c85e09b0fcb2e90507e.png?wh=2874x1438)](https://static001.geekbang.org/resource/image/a6/7e/a63ce910ed343c85e09b0fcb2e90507e.png?wh=2874x1438)
...
首先，我们深度辨析了 Slash Commands（用户调用）与 Hooks（事件驱动）在自动化哲学上的根本区别，明确了 Hooks 是将孤立动作通过事件响应连接起来的关键。接着，我们通过一张清晰的生命周期图，系统性地学习了 Claude Code 开放的各大 Hook 事件（如 PreToolUse、PostToolUse、Notification等）的触发时机和核心价值。

然后，我们通过两个极具代表性的实战，亲手创建了一个用于 Go 代码自动格式化的 PostToolUse Hook，和一个用于保护主干分支的 PreToolUse Hook。最后，我们还了解了调试 Hook 的方法。
...
如何在同一个 Hook 命令中处理不同的文件后缀？（提示：case 语句或多个 if-elif）

这个增强版的 Hook 命令应该是什么样的？
